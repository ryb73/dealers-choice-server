...
function RockPaperScissors($game, $players, $winCounter) {
  ...
  function determineWinner() {
    ...
    let msg = {
      ...
      answers: answersResponse(answerArray)
    };
  ...
  // Converts an answer array to an object that can
  // be sent back to clients
  function answersResponse(answerArray) {
    return answerArray.map(function(answerEntry) {
      return {
